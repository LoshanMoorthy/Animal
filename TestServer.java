...
public class TestServer {
    ...
    private static boolean updateAvailable() {
        ...
        InputStream online = (new URL("https://adamkjelstroem.github.io/IntProg-undervisningsmateriale/web/e22/opgaver/TestServer.java")).openStream()) {
            ...
            System.err.println("Kan ikke lÃ¦se den lokale fil.\nKontakt en adm. instruktor");
        }
    ...
    public static String test(String exercise) throws IOException {
        if (!isAlive()) {
            JOptionPane.showMessageDialog(null, "Testserveren er desvÃ¦rre nede. PrÃ¸v igen senere, og skriv eventuelt pÃ¥ diskussionsforummet, hvis der ikke allerede er gjort det.", "TestServer nede", JOptionPane.ERROR_MESSAGE);
            
            return "";
        }
        
        if(updateAvailable()) {
            int optionChosen = JOptionPane.showOptionDialog(null, "Der er en ny version af TestServer filen, vil du opdatere nu?\n(Dette er pÃ¥krÃ¦vet for at kunne teste opgaver)", "Opdater TestServer fil?", 
                    JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, null, null);
            if (optionChosen == JOptionPane.YES_NO_OPTION) {
                updateTestServer();
            }
